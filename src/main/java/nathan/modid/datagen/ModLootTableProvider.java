...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.GREEN_GARNET_ORE, multipleOreDrops(ModBlocks.GREEN_GARNET_ORE, ModItems.RAW_GREEN_GARNET, 1, 2));
        ...
        addDrop(ModBlocks.GREEN_GARNET_DEEPSLATE_ORE, multipleOreDrops(ModBlocks.GREEN_GARNET_DEEPSLATE_ORE, ModItems.RAW_GREEN_GARNET, 3, 6));
